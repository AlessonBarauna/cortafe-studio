(function () {
  ...
  home = async function () {
    ...
    hero.innerHTML = `<div class="launch-copy"><span class="eyebrow">AMADO JESUS STUDIO · TIKTOK FIRST</span><h1>Um vídeo longo.<br><em>Vários cortes prontos.</em></h1><p>Encontre os melhores momentos, refine no editor e prepare uma sequência completa para o canal Amado Jesus.</p><div class="launch-actions"><button class="btn btn-launch" data-action="new">Criar nova produção →</button></div></div><div class="launch-orbit"><div class="orbit-core"><strong>${clips}</strong><span>cortes criados</span></div><i></i><i></i><i></i></div><div class="launch-metrics"><article><strong>${projects.length}</strong><span>projetos</span></article><article><strong>${ready}</strong><span>prontos</span></article><article><strong>1080p</strong><span>qualidade social</span></article><article><strong>TikTok</strong><span>canal ativo</span></article></div>`;
    bindCommon();
  };
