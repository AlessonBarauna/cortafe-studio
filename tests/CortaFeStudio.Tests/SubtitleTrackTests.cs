...
{
    [Fact]
    public void Ensure_PreservaLegendaGeradaPeloAudioQuandoAtivada()
    {
        var track = new SubtitleTrack
        {
            ...
            EditedByUser = false,
            Confidence = .9,
            Blocks = [new SubtitleBlock { Start = 0, End = 2, Text = "Legenda sincronizada" }]
        };
        var clip = new ClipCandidate { Start = 0, End = 10, SubtitleTrack = track };

        var result = SubtitleTrackService.Ensure(clip, []);
